...
const VerifiedIcon: React.FC<{ onClick?: () => void }> = ({ onClick }) => {
	return (
		<div
			className="w-4 h-4  text-white rounded-full flex items-center justify-center cursor-pointer transition duration-300 "
			onClick={onClick}
		>
			<svg
				viewBox="0 0 24 24"
